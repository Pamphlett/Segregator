...
protected:
    ...
    std::vector<Eigen::Matrix3d, Eigen::aligned_allocator<Eigen::Matrix3d>> src_covariances_matched_;

    std::vector<Eigen::Matrix3d, Eigen::aligned_allocator<Eigen::Matrix3d>> tgt_covariances_matched_;
